...
//
//  private val filePath: String = "src/test/resources/beatles-state.json"
...
//  "helpersReadFileIntoJsonString" should "construct a Right(RosterString)" in {
//    assert(helpersReadFileIntoJsonString(filePath) == Right(jsonString))
//  }
//
